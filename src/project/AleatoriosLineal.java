...
public class AleatoriosLineal {
        ...
        if (metodo == 1) {
            ...
            while (ban == false) {
                ...
                if (constante_aditiva != 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "La constante debe ser mayor a cero!!", "ERROR", JOptionPane.ERROR_MESSAGE);
                }
            }
        } else {
            constante_aditiva = 0;
    ...
    protected void GenerarAleatorios(int semilla, int multiplicador, int constante, int modulo) {
        ...
        JOptionPane.showMessageDialog(null, "Resultado de la operacion:");
